...
exports.renderView = function(options, cb) {
    Promise.coroutine(function * () {
        ...
        yield page.setViewport({width: parseInt(options.dimensions.width),
        ...
        yield page.setViewport({width: parseInt(options.dimensions.width || dimensions.width),
