        ...
        it('should display dashboard', function(done) {
            ...
            request
                ...
                .end(function(err, res) {
                    ...
                    dashboard.should.have.property("total_sessions", { total: 0,
                        change: 'NA',
                        trend: 'u' });
                    dashboard.should.have.property("total_users", { total: 0,
                        change: 'NA',
                        trend: 'u',
                        is_estimate: true });
                    dashboard.should.have.property("new_users", { total: 0,
                        change: 'NA',
                        trend: 'u' });
                    dashboard.should.have.property("total_time", { total: '0.0 min',
                        change: 'NA',
                        trend: 'u' });
                    dashboard.should.have.property("avg_time", { total: '0.0 min',
                        change: 'NA',
                        trend: 'u' });
                    dashboard.should.have.property("avg_requests", { total: '0.0',
                        change: 'NA',
                        trend: 'u' });
