    ...
    describe('using session tests', function() {
        it('should success', function(done) {
            var params = [
                {"device_id": DEVICE_ID,
                    "app_key": APP_KEY,
                    timestamp: parseInt(new Date().getTime() / 1000 - 60 * 6)},
                {"device_id": DEVICE_ID,
                    "app_key": APP_KEY,
                    "begin_session": 1,
                    timestamp: parseInt(new Date().getTime() / 1000 - 60 * 5)},
                {"device_id": DEVICE_ID,
                    "app_key": APP_KEY,
                    "begin_session": 1,
                    timestamp: parseInt(new Date().getTime() / 1000 - 60 * 4)},
                {"device_id": DEVICE_ID,
                    "app_key": APP_KEY,
                    "session_duration": 60,
                    timestamp: parseInt(new Date().getTime() / 1000 - 60 * 60 * 3)},
                {"device_id": DEVICE_ID,
                    "app_key": APP_KEY,
                    "end_session": 1,
                    timestamp: parseInt(new Date().getTime() / 1000 - 60 * 60 * 2)},
                {"device_id": DEVICE_ID + "new",
                    "app_key": APP_KEY,
                    "begin_session": 1,
                    timestamp: parseInt(new Date().getTime() / 1000 - 60 * 60 * 1)},
            ];
        ...
        describe('Verify sessions', function() {
            it('should match sessions tests end result', function(done) {
                request
                    ...
                    .expect(200)
                    .end(function(err, res) {
                        testUtils.validateSessionData(err, res, done, {meta: {"countries": ["Unknown"],
                            "f-ranges": ["0"],
                            "l-ranges": ["0"]},
                        f: {"0": 2},
                        l: {"0": 2},
        ...
        describe('verify dashboard', function() {
            it('should match sessions tests end result', function(done) {
                request
                    ...
                    .expect(200)
                    .end(function(err, res) {
                        testUtils.validateDashboard(err, res, done, {total_sessions: 3,
                            total_users: 2,
                            new_users: 2,
                            total_time: "1.0 min",
                            avg_time: "0.3 min",
        ...
        describe('verify countries', function() {
            it('should match sessions tests end result', function(done) {
                request
                    ...
                    .expect(200)
                    .end(function(err, res) {
                        testUtils.validateCountries(err, res, done, {country: "Unknown",
                            code: "unknown",
                            t: 3,
                            u: 2,
                            u2: 6,
        ...
        it('should success', function(done) {
            var params = [
                ...
                {"device_id": DEVICE_ID + "2",
                    "app_key": APP_KEY,
                    "begin_session": 1,
                    "metrics": {"_os_version": "4.4"}},
                {"device_id": DEVICE_ID + "4",
                    "app_key": APP_KEY,
                    "begin_session": 1,
                    "metrics": {"_resolution": "1200x800"}},
                ...
                {"device_id": DEVICE_ID + "6",
                    "app_key": APP_KEY,
                    "begin_session": 1,
                    "metrics": {"_device": "Nexus 5"}},
                {"device_id": DEVICE_ID + "7",
                    "app_key": APP_KEY,
                    "begin_session": 1,
                    "metrics": {"_carrier": "Vodafone"}},
                {"device_id": DEVICE_ID + "8",
                    "app_key": APP_KEY,
                    "begin_session": 1,
                    "metrics": {"_app_version": "1.0"}},
        ...
        describe('Verify device_details', function() {
            it('should match metrics tests end result', function(done) {
                request
                    ...
                    .expect(200)
                    .end(function(err, res) {
                        testUtils.validateMetrics(err, res, done, {meta: {"os": ["Android", "IOS"],
                            "os_versions": ["4:4", "a4:4", "i7:1"],
                            "resolutions": ["1200x800", "2048x1536"],
                            "app_versions": ["1:0", "1:2"]},
                        Android: {"n": 2,
                            "t": 2,
                            "u": 2},
                        "a4:4": {"n": 1,
        ...
        describe('Verify devices', function() {
            it('should match metrics tests end result', function(done) {
                request
                    ...
                    .expect(200)
                    .end(function(err, res) {
                        testUtils.validateMetrics(err, res, done, {meta: {"devices": ["Nexus 5", "iPod"]},
                            "Nexus 5": {"n": 1,
                                "t": 1,
                                "u": 1},
                            "iPod": {"n": 2,
        ...
        describe('Verify carriers', function() {
            it('should match metrics tests end result', function(done) {
                request
                    ...
                    .expect(200)
                    .end(function(err, res) {
                        testUtils.validateMetrics(err, res, done, {meta: {"carriers": ["Vodafone", "Telecom"]},
                            "Vodafone": {"n": 1,
                                "t": 1,
                                "u": 1},
                            "Telecom": {"n": 2,
        ...
        describe('verify dashboard', function() {
            it('should match metrics tests end result', function(done) {
                request
                    ...
                    .expect(200)
                    .end(function(err, res) {
                        testUtils.validateDashboard(err, res, done, {total_sessions: 9,
                            total_users: 9,
                            new_users: 9,
                            total_time: "0.0 min",
                            avg_time: "0.0 min",
                            ...
                            platforms: [{"name": "Android",
                                ...
                                "value": 2,
                                "percent": 50}],
                            resolutions: [{"name": "2048x1536",
                                "value": 2,
                                "percent": 66}, {"name": "1200x800",
                                "value": 1,
                                "percent": 34}],
                            carriers: [{"name": "Telecom",
                                "value": 2,
                                "percent": 66}, {"name": "Vodafone",
                                "value": 1,
                                "percent": 34}]});
                    });
            });
        ...
        describe('verify test1 event', function() {
            it('should have new segment values and sum updated', function(done) {
                request
                    ...
                    .expect(200)
                    .end(function(err, res) {
                        testUtils.validateEvents(err, res, done, {meta: {"version": ["1:0", "1:2"],
                            "country": ["Latvia", "Turkey"],
                            "market": ["amazon", "googleplay"],
                            "segments": ["country", "market", "version"]},
                        c: 11,
                        s: 5.5});
                    });
            });
        ...
        describe('verify test2 event', function() {
            it('should have add count and sum', function(done) {
                request
                    ...
                    .expect(200)
                    .end(function(err, res) {
                        testUtils.validateEvents(err, res, done, {meta: {"country": ["Latvia"],
                            "market": ["googleplay"],
                            "segments": ["country", "market"]},
                        c: 6,
                        s: 3});
                    });
            });
