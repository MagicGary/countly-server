        ...
        describe('verify dashboard', function() {
            it('should have 1 session and 1 user ', function(done) {
                request
                    ...
                    .expect(200)
                    .end(function(err, res) {
                        testUtils.validateDashboard(err, res, done, {total_sessions: 0,
                            total_users: 0,
                            new_users: 0,
                            total_time: "0.0 min",
                            avg_time: "0.0 min",
        ...
        describe('verify dashboard', function() {
            it('should have 2 sessions and 1 user ', function(done) {
                request
                    ...
                    .expect(200)
                    .end(function(err, res) {
                        testUtils.validateDashboard(err, res, done, {total_sessions: 2,
                            total_users: 1,
                            new_users: 1,
                            total_time: "0.0 min",
                            avg_time: "0.0 min",
        ...
        describe('Verify sessions', function() {
            it('should have 3 sessions with 5 events, 2 users and 30 duration', function(done) {
                request
                    ...
                    .expect(200)
                    .end(function(err, res) {
                        testUtils.validateSessionData(err, res, done, {meta: {"f-ranges": ["0"],
                            "l-ranges": ["0"],
                            "countries": ["Unknown"],
                            "d-ranges": ["1"]},
                        f: {"0": 2},
