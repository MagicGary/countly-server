        ...
        describe('verify merged event', function() {
            it('should have 11 events and 4 sum', function(done) {
                ...
                request
                    ...
                    .expect(200)
                    .end(function(err, res) {
                        testUtils.validateEvents(err, res, done, {c: 11,
                            s: 4});
                    });
            });
        });
        ...
        describe('verify specific event', function() {
            it('should have country and version segments', function(done) {
                request
                    ...
                    .expect(200)
                    .end(function(err, res) {
                        testUtils.validateEvents(err, res, done, {meta: {"version": ["1:0"],
                            "country": ["Turkey"],
                            "segments": ["country", "version"]},
                        c: 7,
                        s: 4});
                    });
            });
        ...
        describe('verify merged event', function() {
            it('should 12 events and 4 sum', function(done) {
                ...
                request
                    ...
                    .expect(200)
                    .end(function(err, res) {
                        testUtils.validateEvents(err, res, done, {c: 12,
                            s: 4});
                    });
            });
        });
        ...
        describe('verify merged event', function() {
            it('should have 14 events and 4 sum', function(done) {
                ...
                request
                    ...
                    .expect(200)
                    .end(function(err, res) {
                        testUtils.validateEvents(err, res, done, {c: 14,
                            s: 4});
                    });
            });
        });
        ...
        describe('verify merged event', function() {
            it('should 16 events and 5.5 sum', function(done) {
                ...
                request
                    ...
                    .expect(200)
                    .end(function(err, res) {
                        testUtils.validateEvents(err, res, done, {c: 16,
                            s: 5.5});
                    });
            });
        });
        ...
        describe('verify merged event', function() {
            it('should 16 events and 5.5 sum', function(done) {
                ...
                request
                    ...
                    .expect(200)
                    .end(function(err, res) {
                        testUtils.validateEvents(err, res, done, {c: 18,
                            s: 7});
                    });
            });
        });
