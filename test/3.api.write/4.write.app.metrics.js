        ...
        describe('Verify device_details', function() {
            it('should have Android OS', function(done) {
                request
                    ...
                    .expect(200)
                    .end(function(err, res) {
                        testUtils.validateMetrics(err, res, done, {meta: {"os": ["Android"]},
                            Android: {"n": 1,
                                "t": 1,
                                "u": 1}});
                    });
        ...
        describe('verify dashboard', function() {
            it('should sessions, users, os', function(done) {
                request
                    ...
                    .expect(200)
                    .end(function(err, res) {
                        testUtils.validateDashboard(err, res, done, {total_sessions: 1,
                            total_users: 1,
                            new_users: 1,
                            total_time: "0.0 min",
                            avg_time: "0.0 min",
        ...
        describe('verify dashboard', function() {
            it('should have sessions, users, os and resolutions', function(done) {
                request
                    ...
                    .expect(200)
                    .end(function(err, res) {
                        testUtils.validateDashboard(err, res, done, {total_sessions: 4,
                            total_users: 4,
                            new_users: 4,
                            total_time: "0.0 min",
                            avg_time: "0.0 min",
        ...
        describe('Verify devices', function() {
            it('should have Nexus 5', function(done) {
                request
                    ...
                    .expect(200)
                    .end(function(err, res) {
                        testUtils.validateMetrics(err, res, done, {meta: {"devices": ["Nexus 5"]},
                            "Nexus 5": {"n": 1,
                                "t": 1,
                                "u": 1}});
                    });
        ...
        describe('Verify carriers', function() {
            it('should have Vodafone', function(done) {
                request
                    ...
                    .expect(200)
                    .end(function(err, res) {
                        testUtils.validateMetrics(err, res, done, {meta: {"carriers": ["Vodafone"]},
                            "Vodafone": {"n": 1,
                                "t": 1,
                                "u": 1}});
                    });
        ...
        describe('verify dashboard', function() {
            it('should have sessions, users, os, resolutions and carriers', function(done) {
                request
                    ...
                    .expect(200)
                    .end(function(err, res) {
                        testUtils.validateDashboard(err, res, done, {total_sessions: 6,
                            total_users: 6,
                            new_users: 6,
                            total_time: "0.0 min",
                            avg_time: "0.0 min",
        ...
        describe('verify dashboard', function() {
            it('should have percentage split between os, resolutions and carriers', function(done) {
                request
                    ...
                    .expect(200)
                    .end(function(err, res) {
                        testUtils.validateDashboard(err, res, done, {total_sessions: 8,
                            total_users: 8,
                            new_users: 8,
                            total_time: "0.0 min",
                            avg_time: "0.0 min",
                            ...
                            resolutions: [{"name": "1200x800",
                                "value": 1,
                                "percent": 50}, {"name": "2048x1536",
                                "value": 1,
                                "percent": 50}],
                            carriers: [{"name": "Telecom",
                                "value": 1,
                                "percent": 50}, {"name": "Vodafone",
                                "value": 1,
                                "percent": 50}]});
                    });
            });
