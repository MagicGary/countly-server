...
var testUtils = function testUtils() {
            ...
            if (i !== "meta") {
                ...
                if (RE.test(i)) {
                    for (var c in correct) {
                        if (c === "Unknown") {
                            ob[i].should.have.property(c, {"u": correct.u,
                                "t": correct.t,
                                "n": correct.n});
                        }
                        else if (c !== "meta") {
                    ...
                    for (j in ob[i]) {
                        if (RE.test(j)) {
                            for (var c in correct) {
                                if (c === "Unknown") {
                                    ob[i][j].should.have.property(c, {"u": correct.u,
                                        "t": correct.t,
                                        "n": correct.n});
                                }
                                else if (c !== "meta") {
                            ...
                            for (k in ob[i][j]) {
                                if (RE.test(k)) {
                                    for (var c in correct) {
                                        if (c === "Unknown") {
                                            ob[i][j][k].should.have.property(c, {"u": correct.u,
                                                "t": correct.t,
                                                "n": correct.n});
                                        }
                                        else if (c !== "meta") {
    ...
    this.validateDashboard = function(err, res, done, correct) {
        ...
        for (var i = 0; i < props.length; i++) {
            ...
            dashboard.should.have.property("total_sessions", {"total": correct.total_sessions,
                "change": "NA",
                "trend": "u"});
            if (prop !== "today" && correct.total_users === 0) {
                dashboard.should.have.property("total_users", {"total": correct.total_users,
                    "change": "NA",
                    "trend": "u",
                    "is_estimate": true});
            }
            ...
            dashboard.should.have.property("new_users", {"total": correct.new_users,
                "change": "NA",
                "trend": "u"});
            dashboard.should.have.property("total_time", {"total": correct.total_time,
                "change": "NA",
                "trend": "u"});
            dashboard.should.have.property("avg_time", {"total": correct.avg_time,
                "change": "NA",
                "trend": "u"});
            dashboard.should.have.property("avg_requests", {"total": correct.avg_requests,
                "change": "NA",
                "trend": "u"});
