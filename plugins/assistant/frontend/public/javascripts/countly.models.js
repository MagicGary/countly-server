                ...
                if (plugins[obj.plugin_name] && plugins[obj.plugin_name][obj.notif_type]) {
                    ...
                    //create a table for a few specific tickets
                    {
                        ...
                        if (obj.plugin_name === "assistant-base" && (obj.notif_type === "2" && obj.notif_subtype === "8")) {
                            var dataToPass = [];
                            dataToPass.push({l: obj.data[0],
                                r: obj.data[1] + ' visitors, ' + obj.data[2] + ' visits'});
                            dataToPass.push({l: obj.data[3],
                                r: obj.data[4] + ' visitors, ' + obj.data[5] + ' visits'});
                            dataToPass.push({l: obj.data[6],
                                r: obj.data[7] + ' visitors, ' + obj.data[8] + ' visits'});
                        ...
                        if (obj.plugin_name === "assistant-base" && (obj.notif_type === "2" && obj.notif_subtype === "7")) {
                            ...
                            var dataToPass = [];
                            dataToPass.push({l: obj.data[0],
                                r: obj.data[1] + " installs"});
                            dataToPass.push({l: obj.data[2],
                                r: obj.data[3] + " installs"});
                            dataToPass.push({l: obj.data[4],
                                r: obj.data[5] + " installs"});
                        ...
                        if (obj.plugin_name === "assistant-base" && (obj.notif_type === "2" && obj.notif_subtype === "5" ||
                            ...
                            var dataToPass = [];
                            dataToPass.push({l: obj.data[0] + ' minutes ' + obj.data[1] + ' seconds',
                                r: 'this week'});
                            dataToPass.push({l: obj.data[2] + ' minutes ' + obj.data[3] + ' seconds',
                                r: 'previous week'});
                        ...
                        if (obj.plugin_name === "assistant-base" && (obj.notif_type === "2" && obj.notif_subtype === "1" ||
                            ...
                            dataToPass.push({l: obj.data[0],
                                r: "users this week"});
                            dataToPass.push({l: obj.data[1],
                                r: "users previous week"});
