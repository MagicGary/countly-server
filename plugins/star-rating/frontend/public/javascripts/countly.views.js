window.starView = countlyView.extend({
    ...
    version: '',
    rating: '',
    ratingFilter: {"comments": {'platform': "",
        "version": "",
        "rating": "",
        "widget": ""},
    "ratings": {'platform': "",
    ...
    addScriptsForFilter: function() {
        ...
        $("#remove-star-rating-filter").on("click", function() {
            if (self._tab === "comments") {
                ...
                self.ratingFilter["ratings"] = {'platform': "",
                    "version": "",
                    "widget": ""};
                self.resetFilterBox(true);
        ...
        $("#apply-star-rating-filter ").on("click", function() {
            ...
            self.ratingFilter[self._tab] = {'platform': "",
                "version": "",
                "widget": ""};
    ...
    renderCommon: function(isRefresh) {
        ...
        if (!isRefresh) {
            ...
            this.ratingFilter = {"comments": {'platform': "",
                "version": "",
                "rating": "",
                "widget": ""},
            "ratings": {'platform': "",
            ...
            $('body').off("click", ".delete-widget").on("click", ".delete-widget", function(event) {
                ...
                }, [jQuery.i18n.map["common.no-dont-delete"], jQuery.i18n.map["feedback.yes-delete-widget"]], {title: jQuery.i18n.map["feedback.delete-a-widget"],
                    image: "delete-an-app"});
            });
