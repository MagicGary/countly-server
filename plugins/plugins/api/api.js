            ...
            if (typeof params.qstring.plugin !== 'undefined' && params.qstring.plugin !== 'plugins') {
                ...
                if (params.qstring.plugin && typeof params.qstring.plugin === 'object') {
                    ...
                    plugins.dispatch("/systemlogs", {params: params,
                        action: "change_plugins",
                        data: {before: before,
                            update: params.qstring.plugin}});
            ...
            if (Object.keys(data).length > 0) {
                if (data["frontend"] && typeof data['frontend']['session_timeout'] !== "undefined") {
                    ...
                    if (params.member.settings && params.member.settings["frontend"] && typeof data['frontend']['session_timeout'] !== "undefined") {}
                        ...
                        common.db.collection("auth_tokens").update({"owner": ob.params.member._id + "",
                            "purpose": "LoggedInAuth"}, {$set: updateArr}, function(err, res1) {
                            if (err) {
                                console.log(err);
                            }
                        });
                ...
                plugins.dispatch("/systemlogs", {params: params,
                    action: "change_configs",
                    data: {before: plugins.getAllConfigs(),
                        update: data}});
