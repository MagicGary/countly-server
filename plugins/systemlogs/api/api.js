...
(function(plugin) {
    ...
    plugins.register("/o", function(ob) {
        ...
        if (params.qstring.method === 'systemlogs') {
            ...
            validate(params, function(params) {
                //get all users
                common.db.collection('members').find({}, {username: 1,
                    email: 1,
                    full_name: 1}).toArray(function(err, users) {
    ...
    plugins.register("/i/app_users/create", function(ob) {
        ob.params = ob.params || {};
        var data = {app_id: ob.app_id,
            user: ob.user,
            uids: ob.user.uid || "",
            res: ob.res};
        recordAction(ob.params, ob.params.member || {_id: "",
            username: "[code]"}, "app_user_created", data);
    });
    ...
    plugins.register("/i/app_users/update", function(ob) {
        ...
        var data = {app_id: ob.app_id,
            query: ob.query,
            update: JSON.stringify(ob.update),
            before: ob.user};
        recordAction(ob.params, ob.params.member || {_id: "",
            username: "[code]"}, "app_user_updated", data);
    });
    ...
    plugins.register("/i/app_users/delete", function(ob) {
        ...
        var data = {app_id: ob.app_id,
            ...
            uids: ob.uids};
        recordAction(ob.params, ob.params.member || {_id: "",
            username: "[code]"}, "app_user_deleted", data);
    });
