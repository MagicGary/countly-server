    ...
    describe('Verify browser', function() {
        it('should have browser', function(done) {
            request
                ...
                .expect(200)
                .end(function(err, res) {
                    testUtils.validateMetrics(err, res, done, {meta: {"browser": ['Chrome']},
                        "Chrome": {"n": 1,
                            "t": 1,
                            "u": 1}});
                });
        ...
        it('should success', function(done) {
            var params = [
                {"device_id": DEVICE_ID + "1",
                    "app_key": APP_KEY,
                    "begin_session": 1,
                    "metrics": {"_browser": "Chrome"}},
                {"device_id": DEVICE_ID + "2",
                    "app_key": APP_KEY,
                    "begin_session": 1,
                    "metrics": {"_browser": "Opera"}},
                {"device_id": DEVICE_ID + "3",
                    "app_key": APP_KEY,
                    "begin_session": 1,
                    "metrics": {"_browser": "Safari"}},
                {"device_id": DEVICE_ID + "4",
                    "app_key": APP_KEY,
                    "begin_session": 1,
                    "metrics": {"_browser": "Firefox"}},
    ...
    describe('Verify bulk browser', function() {
        it('should match provided browser', function(done) {
            request
                ...
                .expect(200)
                .end(function(err, res) {
                    testUtils.validateMetrics(err, res, done, {meta: {"browser": ["Chrome", "Opera", "Safari", "Firefox", "IE"]},
                        "Chrome": {"n": 2,
                            "t": 2,
                            "u": 2},
                        "Opera": {"n": 1,
