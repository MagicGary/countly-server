window.BrowserView = countlyView.extend({
    ...
    renderCommon: function(isRefresh) {
        ...
        for (var i = 0; i < data.chartData.length; i++) {
            segments.push({name: data.chartData[i].browser,
                value: data.chartData[i].browser.toLowerCase()});
        }
            ...
            this.dtable = $('#dataTableOne').dataTable($.extend({}, $.fn.dataTable.defaults, {
                ...
                "aoColumns": [
                    { "mData": "browser",
                        ...
                        "sTitle": jQuery.i18n.map["browser.table.browser"] },
                    { "mData": "t",
                        sType: "formatted-num",
                        "mRender": function(d) {
