    ...
    describe('Verify sources', function() {
        it('should have sources', function(done) {
            request
                ...
                .expect(200)
                .end(function(err, res) {
                    testUtils.validateMetrics(err, res, done, {meta: {"sources": ['com&#46;android&#46;vending']},
                        "com&#46;android&#46;vending": {"n": 1,
                            "t": 1,
                            "u": 1}});
                });
        });
        ...
        it('should success', function(done) {
            var params = [
                {"device_id": DEVICE_ID + "1",
                    "app_key": APP_KEY,
                    "begin_session": 1,
                    "metrics": {"_store": "com.android.vending"}},
                {"device_id": DEVICE_ID + "2",
                    "app_key": APP_KEY,
                    "begin_session": 1,
                    "metrics": {"_store": "com.google.android.feedback"}},
                {"device_id": DEVICE_ID + "3",
                    "app_key": APP_KEY,
                    "begin_session": 1,
                    "metrics": {"_store": "com.slideme.sam.manager"}},
                {"device_id": DEVICE_ID + "4",
                    "app_key": APP_KEY,
                    "begin_session": 1,
                    "metrics": {"_store": "com.amazon.venezia"}},
    ...
    describe('Verify bulk sources', function() {
        it('should match provided sources', function(done) {
            request
                ...
                .expect(200)
                .end(function(err, res) {
                    testUtils.validateMetrics(err, res, done, {meta: {"sources": ["com&#46;android&#46;vending", "com&#46;google&#46;android&#46;feedback", "com&#46;slideme&#46;sam&#46;manager", "com&#46;amazon&#46;venezia", "iOS"]},
                        "com&#46;android&#46;vending": {"n": 2,
                            "t": 2,
                            "u": 2},
                        "com&#46;google&#46;android&#46;feedback": {"n": 1,
                            "t": 1,
                            "u": 1},
                        "com&#46;slideme&#46;sam&#46;manager": {"n": 1,
                            "t": 1,
                            "u": 1},
                        "com&#46;amazon&#46;venezia": {"n": 1,
                            "t": 1,
                            "u": 1},
                        "iOS": {"n": 1,
                            "t": 1,
