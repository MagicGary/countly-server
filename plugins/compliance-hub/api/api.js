...
(function(plugin) {
    ...
    plugins.register("/i", function(ob) {
        ...
        if (params.qstring.consent) {
            ...
            var metrics = {i: {segments: {feature: []},
                value: 1,
                hourlySegments: ["feature"]},
            o: {segments: {feature: []},
                value: 1,
                hourlySegments: ["feature"]}};
            ...
            if (Object.keys(update).length) {
                ...
                plugins.dispatch("/consent/change", {params: params,
                    changes: changes});
            }
        }
    });
            ...
            validateUserForRead(params, function() {
                appUsers.count(params.qstring.app_id, {}, function(err, total) {
                    if (err) {
                        ...
                        params.qstring.query = params.qstring.query || params.qstring.filter || {};
                        params.qstring.project = params.qstring.project || params.qstring.projection || {"did": 1,
                            "d": 1,
                            "av": 1,
                            "consent": 1,
                            "ls": 1,
