        ...
        it('should have no crashes', function(done) {
            ...
            request
                ...
                .end(function(err, res) {
                    ...
                    ob.should.have.property("users", {"total": 0,
                        "affected": 0,
                        "fatal": 0,
                        "nonfatal": 0});
                    ob.should.have.property("crashes", {"total": 0,
                        "unique": 0,
                        "resolved": 0,
                        "unresolved": 0,
                        "fatal": 0,
        ...
        it('should have 1 crash', function(done) {
            request
                ...
                .end(function(err, res) {
                    ...
                    var ob = JSON.parse(res.text);
                    ob.should.have.property("users", {"total": 1,
                        "affected": 1,
                        "fatal": 0,
                        "nonfatal": 1});
                    ob.should.have.property("crashes", {"total": 1,
                        "unique": 1,
                        "resolved": 0,
                        "unresolved": 1,
                        "fatal": 0,
        ...
        it('should have provided details', function(done) {
            request
                ...
                .end(function(err, res) {
                    ...
                    ob.should.have.property("custom", {"facebook": {"3:0": 1},
                        "googleplay": {"1:0": 1}});
                    ...
                    ob.should.have.property("ram", {"total": 50,
                        "count": 1,
                        "min": 50,
                        "max": 50});
                    ob.should.have.property("bat", {"total": 40,
                        "count": 1,
                        "min": 40,
                        "max": 40});
                    ob.should.have.property("disk", {"total": 20,
                        "count": 1,
                        "min": 20,
                        "max": 20});
                    ob.should.have.property("run", {"total": 60,
                        "count": 1,
                        "min": 60,
                        "max": 60});
                    ...
                    report.should.have.property("custom", {"facebook": "3.0",
                        "googleplay": "1.0"});
        ...
        it('should have 1 crash', function(done) {
            request
                ...
                .end(function(err, res) {
                    ...
                    var ob = JSON.parse(res.text);
                    ob.should.have.property("users", {"total": 2,
                        "affected": 2,
                        "fatal": 0,
                        "nonfatal": 2});
                    ob.should.have.property("crashes", {"total": 2,
                        "unique": 1,
                        "resolved": 0,
                        "unresolved": 1,
                        "fatal": 0,
        ...
        it('should have provided details', function(done) {
            request
                ...
                .end(function(err, res) {
                    ...
                    ob.should.have.property("custom", {"facebook": {"3:0": 2},
                        "googleplay": {"1:0": 2}});
                    ...
                    ob.should.have.property("ram", {"total": 100,
                        "count": 2,
                        "min": 50,
                        "max": 50});
                    ob.should.have.property("bat", {"total": 80,
                        "count": 2,
                        "min": 40,
                        "max": 40});
                    ob.should.have.property("disk", {"total": 40,
                        "count": 2,
                        "min": 20,
                        "max": 20});
                    ob.should.have.property("run", {"total": 120,
                        "count": 2,
                        "min": 60,
                        "max": 60});
                    ...
                    report2.should.have.property("custom", {"facebook": "3.0",
                        "googleplay": "1.0"});
            ...
            request
                ...
                .end(function(err, res) {
                    ...
                    ob.should.have.property("users", {"total": 2,
                        ...
                        "fatal": 0,
                        "nonfatal": 2});
                    ob.should.have.property("crashes", {"total": 3,
                        "unique": 1,
                        "resolved": 0,
                        "unresolved": 1,
                        "fatal": 0,
        ...
        it('should have provided details', function(done) {
            request
                ...
                .end(function(err, res) {
                    ...
                    ob.should.have.property("background", {"yes": 2,
                        "no": 1});
                    ob.should.have.property("ram", {"total": 175,
                        "count": 3,
                        "min": 50,
                        "max": 75});
                    ob.should.have.property("bat", {"total": 170,
                        "count": 3,
                        "min": 40,
                        "max": 90});
                    ob.should.have.property("disk", {"total": 65,
                        "count": 3,
                        "min": 20,
                        "max": 25});
                    ob.should.have.property("run", {"total": 240,
                        "count": 3,
                        "min": 60,
                        "max": 120});
                    ob.should.have.property("session", {"total": 1,
                        "count": 1,
                        "min": 1,
                        "max": 1});
                    ob.should.have.property("total", 2);
            ...
            request
                ...
                .end(function(err, res) {
                    ...
                    ob.should.have.property("users", {"total": 2,
                        ...
                        "fatal": 1,
                        "nonfatal": 1});
                    ob.should.have.property("crashes", {"total": 4,
                        "unique": 2,
                        "resolved": 0,
                        "unresolved": 2,
                        "fatal": 1,
        ...
        it('should have provided details', function(done) {
            request
                ...
                .end(function(err, res) {
                    ...
                    ob.should.have.property("ram", {"total": 75,
                        "count": 1,
                        "min": 75,
                        "max": 75});
                    ob.should.have.property("bat", {"total": 90,
                        "count": 1,
                        "min": 90,
                        "max": 90});
                    ob.should.have.property("disk", {"total": 25,
                        "count": 1,
                        "min": 25,
                        "max": 25});
                    ob.should.have.property("run", {"total": 120,
        ...
        it('should have 3 crash', function(done) {
            request
                ...
                .end(function(err, res) {
                    ...
                    var ob = JSON.parse(res.text);
                    ob.should.have.property("users", {"total": 3,
                        "affected": 3,
                        "fatal": 2,
                        "nonfatal": 1});
                    ob.should.have.property("crashes", {"total": 5,
                        "unique": 3,
                        "resolved": 0,
                        "unresolved": 3,
                        "fatal": 2,
        ...
        it('should be found', function(done) {
            request
                ...
                .end(function(err, res) {
                    ...
                    var data = parts[1].split(";\nwindow.CrashgroupView")[0];
                    var ob = JSON.parse(data);
                    ob.should.have.property('share', {"reports": 1,
                        "loss": 1,
                        "users": 1});
            ...
            request
                ...
                .end(function(err, res) {
                    ...
                    ob.should.have.property("users", {"total": 3,
                        ...
                        "fatal": 2,
                        "nonfatal": 1});
                    ob.should.have.property("crashes", {"total": 6,
                        "unique": 3,
                        "resolved": 0,
                        "unresolved": 3,
                        "fatal": 2,
        ...
        it('should be resolved', function(done) {
            request
                ...
                .end(function(err, res) {
                    ...
                    ob.should.have.property("users", 1);
                    ob.should.have.property("os_version", {"4:0": 3,
                        "4:1": 1});
                    ob.should.have.property("manufacture", {"Samsung": 4});
                    ob.should.have.property("device", {"Galaxy S3": 3,
                        "Galaxy S4": 1});
                    ob.should.have.property("resolution", {"480x800": 3,
                        "800x1900": 1});
                    ob.should.have.property("app_version", {"1:1": 2,
                        "1:2": 1,
                        "1:3": 1});
                    ...
                    ob.should.have.property("orientation", {"landscape": 3,
                        "portrait": 1});
                    ob.should.have.property("custom", {"facebook": {"3:0": 3,
                        "3:5": 1},
                    "googleplay": {"1:0": 3,
                        "2:0": 1}});
                    ob.should.have.property("root", {"yes": 3,
                        "no": 1});
                    ob.should.have.property("online", {"no": 3,
                        "yes": 1});
                    ob.should.have.property("muted", {"no": 3,
                        "yes": 1});
                    ob.should.have.property("signal", {"yes": 3,
                        "no": 1});
                    ob.should.have.property("background", {"yes": 3,
                        "no": 1});
                    ob.should.have.property("ram", {"total": 225,
                        "count": 4,
                        "min": 50,
                        "max": 75});
                    ob.should.have.property("bat", {"total": 210,
                        "count": 4,
                        "min": 40,
                        "max": 90});
                    ob.should.have.property("disk", {"total": 85,
                        "count": 4,
                        "min": 20,
                        "max": 25});
                    ob.should.have.property("run", {"total": 300,
                        "count": 4,
                        "min": 60,
                        "max": 120});
                    ob.should.have.property("session", {"total": 1,
            ...
            request
                ...
                .end(function(err, res) {
                    ...
                    ob.should.have.property("users", {"total": 3,
                        ...
                        "fatal": 2,
                        "nonfatal": 1});
                    ob.should.have.property("crashes", {"total": 7,
                        "unique": 3,
                        "resolved": 0,
                        "unresolved": 3,
                        "fatal": 2,
        ...
        it('should be resolved', function(done) {
            request
                ...
                .end(function(err, res) {
                    ...
                    ob.should.have.property("users", 1);
                    ob.should.have.property("os_version", {"4:0": 4,
                        "4:1": 1});
                    ob.should.have.property("manufacture", {"Samsung": 5});
                    ob.should.have.property("device", {"Galaxy S3": 4,
                        "Galaxy S4": 1});
                    ob.should.have.property("resolution", {"480x800": 4,
                        "800x1900": 1});
                    ob.should.have.property("app_version", {"1:1": 2,
                        "1:2": 1,
                        "1:3": 2});
                    ...
                    ob.should.have.property("orientation", {"landscape": 4,
                        "portrait": 1});
                    ob.should.have.property("custom", {"facebook": {"3:0": 4,
                        "3:5": 1},
                    "googleplay": {"1:0": 4,
                        "2:0": 1}});
                    ob.should.have.property("root", {"yes": 4,
                        "no": 1});
                    ob.should.have.property("online", {"no": 4,
                        "yes": 1});
                    ob.should.have.property("muted", {"no": 4,
                        "yes": 1});
                    ob.should.have.property("signal", {"yes": 4,
                        "no": 1});
                    ob.should.have.property("background", {"yes": 4,
                        "no": 1});
                    ob.should.have.property("ram", {"total": 275,
                        "count": 5,
                        "min": 50,
                        "max": 75});
                    ob.should.have.property("bat", {"total": 250,
                        "count": 5,
                        "min": 40,
                        "max": 90});
                    ob.should.have.property("disk", {"total": 105,
                        "count": 5,
                        "min": 20,
                        "max": 25});
                    ob.should.have.property("run", {"total": 360,
                        "count": 5,
                        "min": 60,
                        "max": 120});
                    ob.should.have.property("session", {"total": 3,
                        "count": 2,
                        "min": 1,
                        "max": 2});
                    ob.should.have.property("total", 3);
            ...
            request
                ...
                .end(function(err, res) {
                    ...
                    ob.should.have.property("users", {"total": 3,
                        ...
                        "fatal": 2,
                        "nonfatal": 1});
                    ob.should.have.property("crashes", {"total": 8,
                        "unique": 4,
                        "resolved": 0,
                        "unresolved": 4,
                        "fatal": 3,
            ...
            request
                ...
                .end(function(err, res) {
                    ...
                    ob.should.have.property("users", {"total": 3,
                        ...
                        "fatal": 2,
                        "nonfatal": 1});
                    ob.should.have.property("crashes", {"total": 9,
                        "unique": 4,
                        "resolved": 0,
                        "unresolved": 4,
                        "fatal": 4,
