    ...
    describe('Verify density', function() {
        it('should have density', function(done) {
            request
                ...
                .expect(200)
                .end(function(err, res) {
                    testUtils.validateMetrics(err, res, done, {meta: {"density": ['400dpi']},
                        "400dpi": {"n": 1,
                            "t": 1,
                            "u": 1}});
                });
        ...
        it('should success', function(done) {
            var params = [
                {"device_id": DEVICE_ID + "1",
                    "app_key": APP_KEY,
                    "begin_session": 1,
                    "metrics": {"_density": "100dpi"}},
                {"device_id": DEVICE_ID + "2",
                    "app_key": APP_KEY,
                    "begin_session": 1,
                    "metrics": {"_density": "200dpi"}},
                {"device_id": DEVICE_ID + "3",
                    "app_key": APP_KEY,
                    "begin_session": 1,
                    "metrics": {"_density": "300dpi"}},
                {"device_id": DEVICE_ID + "4",
                    "app_key": APP_KEY,
                    "begin_session": 1,
                    "metrics": {"_density": "400dpi"}},
                {"device_id": DEVICE_ID + "5",
                    "app_key": APP_KEY,
                    "begin_session": 1,
                    "metrics": {"_density": "500dpi"}},
                {"device_id": DEVICE_ID + "6",
                    "app_key": APP_KEY,
                    "begin_session": 1,
                    "metrics": {"_density": "600dpi"}},
                {"device_id": DEVICE_ID + "7",
                    "app_key": APP_KEY,
                    "begin_session": 1,
                    "metrics": {"_density": "700dpi"}},
                {"device_id": DEVICE_ID + "8",
                    "app_key": APP_KEY,
                    "begin_session": 1,
                    "metrics": {"_density": "800dpi"}},
                {"device_id": DEVICE_ID + "9",
                    "app_key": APP_KEY,
                    "begin_session": 1,
                    "metrics": {"_density": "900dpi"}}
            ];
    ...
    describe('Verify bulk density', function() {
        it('should match provided density', function(done) {
            request
                ...
                .expect(200)
                .end(function(err, res) {
                    testUtils.validateMetrics(err, res, done, {meta: {"density": ["100dpi", "200dpi", "300dpi", "400dpi", "500dpi", "600dpi", "700dpi", "800dpi", "900dpi"]},
                        "100dpi": {"n": 1,
                            "t": 1,
                            "u": 1},
                        "200dpi": {"n": 1,
