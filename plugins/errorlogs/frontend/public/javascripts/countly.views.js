    ...
    renderCommon: function(isRefresh) {
        ...
        if (!isRefresh) {
            ...
            $(".btn-clear-log").on("click", function() {
                ...
                }, [jQuery.i18n.map["common.no-dont-delete"], jQuery.i18n.map["common.yes-clear-it"]], {title: jQuery.i18n.map["errorlogs.confirm-delete-" + id + "-title"] || jQuery.i18n.map["errorlogs.confirm-delete-title"],
                    image: "clear-api-logs"});
            });
        }
    },
    refresh: function() {
