    ...
    describe('Verify Language', function() {
        it('should have language', function(done) {
            request
                ...
                .expect(200)
                .end(function(err, res) {
                    testUtils.validateMetrics(err, res, done, {meta: {"langs": ['en']},
                        "en": {"n": 1,
                            "t": 1,
                            "u": 1}});
                });
        ...
        it('should success', function(done) {
            var params = [
                {"device_id": DEVICE_ID + "1",
                    "app_key": APP_KEY,
                    "begin_session": 1,
                    "metrics": {"_locale": "en_CA"}},
                {"device_id": DEVICE_ID + "2",
                    "app_key": APP_KEY,
                    "begin_session": 1,
                    "metrics": {"_locale": "fr_FR"}},
                {"device_id": DEVICE_ID + "3",
                    "app_key": APP_KEY,
                    "begin_session": 1,
                    "metrics": {"_locale": "zh_CN"}},
                {"device_id": DEVICE_ID + "4",
                    "app_key": APP_KEY,
                    "begin_session": 1,
                    "metrics": {"_locale": "de_DE"}},
                {"device_id": DEVICE_ID + "5",
                    "app_key": APP_KEY,
                    "begin_session": 1,
                    "metrics": {"_locale": "it_IT"}},
                {"device_id": DEVICE_ID + "6",
                    "app_key": APP_KEY,
                    "begin_session": 1,
                    "metrics": {"_locale": "ja_JP"}},
                {"device_id": DEVICE_ID + "7",
                    "app_key": APP_KEY,
                    "begin_session": 1,
                    "metrics": {"_locale": "ko_KR"}},
                {"device_id": DEVICE_ID + "8",
                    "app_key": APP_KEY,
                    "begin_session": 1,
                    "metrics": {"_locale": "en_US"}}
            ];
    ...
    describe('Verify bulk language', function() {
        it('should match provided language', function(done) {
            request
                ...
                .expect(200)
                .end(function(err, res) {
                    testUtils.validateMetrics(err, res, done, {meta: {"langs": ["en", "fr", "zh_hans", "de", "it", "ja", "ko"]},
                        "en": {"n": 3,
                            "t": 3,
                            "u": 3},
                        "fr": {"n": 1,
