window.PopulatorView = countlyView.extend({
    ...
    renderCommon: function(isRefresh) {
        ...
        if (countlyPopulator.isGenerating()) {
            ...
            $("#populate-from").datepicker({dateFormat: "yy-mm-dd",
                defaultDate: new Date(countlyPopulator.getStartTime() * 1000),
                constrainInput: true,
                maxDate: now });
            $("#populate-to").datepicker({dateFormat: "yy-mm-dd",
                defaultDate: new Date(countlyPopulator.getEndTime() * 1000),
                constrainInput: true,
                maxDate: now });
        }
        else {
