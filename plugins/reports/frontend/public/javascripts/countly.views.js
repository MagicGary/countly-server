window.ReportingView = countlyView.extend({
        ...
        if (!isRefresh) {
            ...
            self.dtable = $('#reports-table').dataTable($.extend({}, $.fn.dataTable.defaults, {
                ...
                "aoColumns": [
                    {"mData": 'title',
                        "sType": "string",
                        "sTitle": jQuery.i18n.map['report.report-title']},
                    {
    ...
    initReportsWidget: function(reportType) {
        ...
        $("#frequency-dropdown").clySelectSetItems([
            {name: jQuery.i18n.map["reports.daily"],
                value: "daily"},
            {name: jQuery.i18n.map["reports.weekly"],
                value: "weekly"}
        ]);
        ...
        $("#include-metrics-dropdown").clyMultiSelectSetItems([
            {name: jQuery.i18n.map["reports.analytics"],
                value: "analytics"},
            {name: jQuery.i18n.map["reports.events"],
                value: "events"},
            {name: jQuery.i18n.map["reports.revenue"],
                value: "revenue"},
            {name: jQuery.i18n.map["reports.crash"],
                value: "crash"},
        ]);
        ...
        var weekList = [
            {name: jQuery.i18n.map["reports.monday"],
                value: 1},
            {name: jQuery.i18n.map["reports.tuesday"],
                value: 2},
            {name: jQuery.i18n.map["reports.wednesday"],
                value: 3},
            {name: jQuery.i18n.map["reports.thursday"],
                value: 4},
            {name: jQuery.i18n.map["reports.friday"],
                value: 5},
            {name: jQuery.i18n.map["reports.saturday"],
                value: 6},
            {name: jQuery.i18n.map["reports.sunday"],
                value: 7},
        ...
        loadData: function(data) {
            ...
            if (emailInput && emailInput.length > 0) {
                for (var i = 0; i < data.emails.length; i++) {
                    (emailInput[0]).selectize.addOption({ "name": '',
                        "email": data.emails[i] });
                }
            ...
            if (reportType === "core") {
                ...
                for (var index in data.apps) {
                    ...
                    appSelected.push({name: countlyGlobal.apps[appId].name,
                        value: appId});
                }
    ...
    initTable: function() {
        ...
        $(".delete-report").off("click").on("click", function(e) {
            ...
            }, [jQuery.i18n.map["common.no-dont-delete"], jQuery.i18n.map["reports.yes-delete-report"]], {title: jQuery.i18n.map["reports.delete-report-title"],
                image: "delete-email-report"});
        });
