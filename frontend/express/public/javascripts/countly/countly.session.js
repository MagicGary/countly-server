(function() {
    ...
    CountlyHelpers.createMetricModel(window.countlySession, {name: "users",
        estOverrideMetric: "users"}, jQuery);
    ...
    countlySession.getSessionDP = function() {
        ...
        var chartData = [
                { data: [],
                    label: jQuery.i18n.map["common.table.total-sessions"] },
                { data: [],
                    label: jQuery.i18n.map["common.table.new-sessions"] },
                { data: [],
                    label: jQuery.i18n.map["common.table.unique-sessions"] }
            ],
            dataProps = [
                { name: "t" },
                { name: "n" },
    ...
    countlySession.getUserDP = function() {
        ...
        var chartData = [
                { data: [],
                    label: jQuery.i18n.map["common.table.total-users"] },
                { data: [],
                    label: jQuery.i18n.map["common.table.new-users"] },
                { data: [],
                    label: jQuery.i18n.map["common.table.returning-users"] }
            ],
            dataProps = [
                { name: "u" },
                { name: "n" },
    ...
    countlySession.getMsgUserDPActive = function() {
        ...
        var chartData = [
                ...
                { data: [],
                    label: jQuery.i18n.map["common.table.messaging-users"],
    ...
    countlySession.getDurationDP = function() {
        ...
        var chartData = [
                { data: [],
                    label: jQuery.i18n.map["common.graph.time-spent"],
                    color: '#DDDDDD',
                    mode: "ghost"},
                { data: [],
                    label: jQuery.i18n.map["common.graph.time-spent"],
    ...
    countlySession.getDurationDPAvg = function() {
        ...
        var chartData = [
                { data: [],
                    label: jQuery.i18n.map["common.graph.average-time"],
                    color: '#DDDDDD',
                    mode: "ghost"},
                { data: [],
                    label: jQuery.i18n.map["common.graph.average-time"],
    ...
    countlySession.getEventsDP = function() {
        ...
        var chartData = [
                { data: [],
                    label: jQuery.i18n.map["common.graph.reqs-received"],
                    color: '#DDDDDD',
                    mode: "ghost"},
                { data: [],
                    label: jQuery.i18n.map["common.graph.reqs-received"],
    ...
    countlySession.getEventsDPAvg = function() {
        ...
        var chartData = [
                { data: [],
                    label: jQuery.i18n.map["common.graph.avg-reqs-received"],
                    color: '#DDDDDD',
                    mode: "ghost"},
                { data: [],
                    label: jQuery.i18n.map["common.graph.avg-reqs-received"],
    ...
    countlySession.getTopUserBars = function() {
        ...
        for (var i = 0; i < maxItems; i++) {
            ...
            barData[i] = { "name": topUsers[i]["date"],
                "count": topUsers[i]["t"],
                "type": "user",
                "percent": percent };
        }
