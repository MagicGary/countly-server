...
var preset_sg = {
    ...
    "[CLY]_crash": {
        ...
        "background": { name: "background",
            type: "l" },
        "ram_current": { name: "ram_current",
            type: "n" },
        "ram_total": { name: "ram_total",
            type: "n" },
        "disk_current": { name: "disk_current",
            type: "n" },
        "disk_total": { name: "disk_total",
            type: "n" },
        "bat_current": { name: "bat_current",
            type: "n" },
        "bat_total": { name: "bat_total",
            type: "n" },
        "bat": { name: "bat",
            type: "n" },
        "run": { name: "run",
...
var drillConfigs = {list_limit: 100,
    big_list_limit: 128000};
