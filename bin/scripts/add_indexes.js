...
countlyDb.collection('apps').find({}).toArray(function(err, apps) {
    ...
    function upgrade(app, done) {
        ...
        countlyDb.collection('app_users' + app._id).ensureIndex({"lac": 1,
            "ls": 1}, { background: true }, cb);
        ...
        countlyDb.collection('app_user_merges' + app._id).ensureIndex({cd: 1}, {expireAfterSeconds: 60 * 60 * 3,
            background: true}, cb);
